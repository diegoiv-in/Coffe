new Vue({
    ...
    data:{
        articulos:[
            { vig: "Disponible", 
            bebida:"Cafe con Vainilla", 
            ing: "Café normal con escencia de vainilla", 
            tam:"Mediano",
             precio: "$29"}, 
            { vig: "No Disponible", 
            bebida:"Smothie de Mango", 
            ing: "leche con pulpa de Mango", 
            tam:"Grande",
             precio: "$49"}, 
            { vig: "Disponible",
             bebida:"Capuchino Americano", 
             ing: "café expreso y leche montada",
              tam:"Mediano", 
              precio: "$59"}, 
            { vig: "Disponible",
             bebida:"Te de Menta",
              ing: "Hojas de menta fermentadas",
               tam:"Grande",
                precio: "$49"}, 
            { vig: "No Disponible", 
            bebida:"Frappe de Kahlua",
             ing: "Leche con escencia de vainilla y 1 taza de kahlua",
              tam:"Mediano",
               precio: "$29"}, 
            { vig: "Disponible", 
            bebida:"Cafe de olla ", 
            ing: "Cafe normal con un toque de Canela",
             tam:"Grande", precio: "$39"}, 
...
new Vue({
    ...
    data:{
        ...
        {cant:1,nombre:'Cafe de olla ',precio_unit:39,precio_items:0}
